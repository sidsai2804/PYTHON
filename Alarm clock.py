...
class AlarmClock:
    ...
    def set_alarm(self):
        ...
        if alarm_time in self.alarms:
            ...
            # Start a new thread to wait for the alarm time
            self.alarm_thread = Thread(target=self.wait_for_alarm, args=(alarm_time,))
    ...
    def play_alarm(self):
        messagebox.showwarning("Alarm", "Time to wake up!", icon='warning')
